document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateVideoUrls(tweetId) {
    ...
    videoForm.addEventListener('submit', async (e) => {
        ...
        if (!url) {
            errorMessage.textContent = 'Please enter a Twitter video URL';
        ...
        if (!tweetId) {
            errorMessage.textContent = 'Invalid Twitter video URL';
            errorContainer.classList.remove('d-none');
            return;
        }
        ...
        try {
            const videos = generateVideoUrls(tweetId);
            videoGrid.innerHTML = '';
            videos.forEach(video => {
